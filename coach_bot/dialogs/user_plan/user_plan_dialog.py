...
from coach_bot.dialogs.user_menu.handlers.main_menu_handlers import on_progress_clicked
...
user_plan_dialog = Dialog(
    Window(
        ...
        kbd.Row(
            ...
            kbd.Button(Const("📈 Мой прогресс"), id="progress_plan", on_click=on_progress_clicked),
        ),
        kbd.Row(
